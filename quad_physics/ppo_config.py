config = {
    "run_name": "quad_physics_curriculum_v3",
    "learning_rate": 3e-4,
    "n_steps": 1024,
    "batch_size": 64,
    "gamma": 0.99,
    ...
    "curriculum": [
        ...
        # ── Stage 3b: tiny pipe, fixed pickup/delivery ───────────────────
        {
            "name": "s3b_fixed_pipe_tiny",
            "grid_size": [2, 2],
            "max_steps": 200,
            "timesteps": 250_000,
            "map_seed": 42,
        ...
        # ── Stage 3c: tiny pipe grid, random package ──────────────────────
        {
            "name": "s3c_pipe_tiny",
            "grid_size": [2, 2],
            "max_steps": 200,
        ...
        # ── Stage 3d: small pipe grid, fixed delivery ─────────────────────
        {
        ...
        # ── Stage 6: random both, bridge pipe ────────────────────────────
        {
            "name": "s6_random_both_bridge_pipe_physics",
            "grid_size": [5, 5],
            "max_steps": 1800,
            "timesteps": 900_000,
            "map_seed": 202,
            ...
            "package_max_dist": 13,
            "delivery_min_dist": 5,
            "delivery_max_dist": 13,
            "delivery_min_start_dist": 10,
            "randomize_package": True,
            "randomize_delivery": True,
            "eval_every": 25_000,
        ...
        # ── Stage 7: medium pipe, fixed pickup/delivery ──────────────────
        {
            "name": "s7_fixed_medium_pipe_physics",
            "grid_size": [6, 6],
            "max_steps": 2400,
            "timesteps": 700_000,
            "map_seed": 303,
        ...
        # ── Stage 8: medium pipe, random package ─────────────────────────
        {
            "name": "s8_random_package_medium_pipe_physics",
            "grid_size": [6, 6],
            "max_steps": 2400,
            "timesteps": 900_000,
            "map_seed": 303,
        ...
        # ── Stage 9: medium pipe, random both explore ────────────────────
        {
            "name": "s9_random_both_medium_pipe_explore_physics",
            "grid_size": [6, 6],
            "max_steps": 2400,
            "timesteps": 1_200_000,
            "map_seed": 303,
        ...
        # ── Stage 10: same medium pipe, lower-noise polish ───────────────
        {
            "name": "s10_random_both_medium_pipe_polish_physics",
            "grid_size": [6, 6],
            "max_steps": 2400,
            "timesteps": 1_000_000,
            "map_seed": 303,
