...
class SARSADrone:
    ...
    def train_lambda_backward(self, start_pos, lmbda=0.9, episodes=700):
        ...
        print("Backward-view lambda complete!")
...
if __name__ == "__main__":
    ...
    drone.train_lambda_backward(start_pos, episodes=700)
