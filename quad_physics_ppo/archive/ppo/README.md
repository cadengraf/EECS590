...
```bash
./reinforcement_learning/bin/python -m quad_physics_ppo.ppo
```
...
```text
quad_physics_ppo/checkpoints/ppo/task1/quad_physics_curriculum_v1/
```
...
from quad_physics_ppo.ppo import build_env
